...
provider "registry.terraform.io/cloudfoundry-community/cloudfoundry" {
  ...
  hashes = [
    ...
    "h1:WfTX0FERSdCtWZtxPFsBqVbbFMVJG8DtebC4i8VLm5Y=",
    "h1:WlfTIO7Zrd64R7zyMBLpgioiUKufT0aIFpfcI0uec7g=",
    "h1:YfX8PHHUqwcDDE6IiaH9dyRSmHtqYeditQSuOHPyJzk=",
...
provider "registry.terraform.io/philips-software/hsdp" {
  version     = "0.26.3"
  constraints = ">= 0.17.0, >= 0.26.3"
  hashes = [
    "h1:L9QEXx3dyfcfeOV8wqxODpcgxgnoDzE8/TL4jo5Nbmg=",
